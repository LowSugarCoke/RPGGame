...
class AdventurerAttribute():
    ...
    def drawDialog(self):
        ...
        self.swordsmanPosition.x =  self.screen.get_width()*5//20
        ...
        swordsManTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *3 // 32)
        ...
        swordsManText = self.font.render(swordsManContent, True, black, white)
        swordsManTextRect = swordsManText.get_rect()
        swordsManTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *4 // 32)
        self.screen.blit(swordsManText, swordsManTextRect)

        swordsManContent = "Damage range:"+str(self.adventurer[0].damageCountDistance[0])+"~"+str(self.adventurer[0].damageCountDistance[1])
        swordsManText = self.font.render(swordsManContent, True, black, white)
        swordsManTextRect = swordsManText.get_rect()
        swordsManTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *5 // 32)
        self.screen.blit(swordsManText, swordsManTextRect)
  
        # Archer
        self.archerPosition = self.adventurer[1].image.get_rect()
        self.archerPosition.x =  self.screen.get_width()*5//20
        ...
        archerTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *9 // 32)
        ...
        archerText = self.font.render(archerContentContent, True, black, white)
        archerTextRect = archerText.get_rect()
        archerTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *10 // 32)
        self.screen.blit(archerText, archerTextRect)
        ...
        archerTextRect = archerText.get_rect()
        archerTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *11 // 32)
        self.screen.blit(archerText, archerTextRect)

        # Orc
        self.orcPosition = self.adventurer[2].image.get_rect()
        self.orcPosition.x =  self.screen.get_width()*5//20
        ...
        orcTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *15 // 32)
        ...
        orcText = self.font.render(orcContentContent, True, black, white)
        orcTextRect = orcText.get_rect()
        orcTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *16 // 32)
        self.screen.blit(orcText, orcTextRect)
        ...
        orcTextRect = orcText.get_rect()
        orcTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *17 // 32)
        self.screen.blit(orcText, orcTextRect)

        # Magician
        self.magicianPosition = self.adventurer[3].image.get_rect()
        self.magicianPosition.x =  self.screen.get_width()*5//20
        ...
        magicianTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *21 // 32)
        ...
        magicianText = self.font.render(magicianContentContent, True, black, white)
        magicianTextRect = magicianText.get_rect()
        magicianTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *22 // 32)
        self.screen.blit(magicianText, magicianTextRect)
        ...
        magicianTextRect = magicianText.get_rect()
        magicianTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *23 // 32)
        self.screen.blit(magicianText, magicianTextRect)
        
        # Priest
        self.priestPosition = self.adventurer[4].image.get_rect()
        self.priestPosition.x =  self.screen.get_width()*5//20
        ...
        priestTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *27 // 32)
        ...
        priestText = self.font.render(priestContentContent, True, black, white)
        priestTextRect = priestText.get_rect()
        priestTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *28 // 32)
        self.screen.blit(priestText, priestTextRect)
        ...
        priestTextRect = priestText.get_rect()
        priestTextRect.center = (self.screen.get_width()*6 // 10, self.screen.get_height() *29 // 32)
        self.screen.blit(priestText, priestTextRect)
